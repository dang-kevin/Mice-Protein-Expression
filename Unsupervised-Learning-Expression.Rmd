...
```{r figHCheat, echo=F, fig.width=8, fig.height=10, fig.cap="\\label{fig:figHCheat}Heatmap of Protein Expression Levels by Cluster, Hierarchical Clustering"}
...
```{r figKMPAM, echo=F, fig.width=10, fig.height=13, fig.cap="\\label{fig:figKMPAM}Heatmap of Protein Expression Levels by Cluster, K-Means & PAM"}
...
```{r figPCAvar, echo=F, fig.width=9, fig.cap="\\label{fig:figPCAvar}Principal Component Analysis, Cumulative Proportion of Variance Explained"}
...
```{r figPCAclass, echo=F, fig.width=9, fig.cap="\\label{fig:figPCAclass}Principal Component Analysis, first two components"}
...
```{r figHCsil, echo=F, fig.width=8, fig.cap="\\label{fig:figHCsil}Silhouette Width, Hierarchical Clustering"}
...
```{r figKMsil, echo=F, fig.width=8, fig.cap="\\label{fig:figKMsil}Silhouette Width, K-Means Clustering"}
...
```{r figPAMsil, echo=F, fig.width=8, fig.cap="\\label{fig:figPAMsil}Silhouette Width, Partitioning Around Medoids"}
